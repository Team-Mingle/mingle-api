...
public class QPost extends EntityPathBase<Post> {
    ...
    public final ListPath<community.mingle.api.domain.like.entity.PostLike, community.mingle.api.domain.like.entity.QPostLike> postLikeList = this.<community.mingle.api.domain.like.entity.PostLike, community.mingle.api.domain.like.entity.QPostLike>createList("postLikeList", community.mingle.api.domain.like.entity.PostLike.class, community.mingle.api.domain.like.entity.QPostLike.class, PathInits.DIRECT2);
